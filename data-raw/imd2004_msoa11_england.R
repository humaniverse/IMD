...
imd2004_msoa11_england <- imd_msoa

# Save output to data/ folder
usethis::use_data(imd2004_msoa11_england, overwrite = TRUE)
readr::write_csv(imd2004_msoa11_england, "data-raw/imd2004_msoa11_england.csv")
