...
# ---- Combine ----
imd2017_soa01_northern_ireland_indicators <-
  income |>
...
usethis::use_data(imd2017_soa01_northern_ireland_indicators, overwrite = TRUE)
readr::write_csv(imd2017_soa01_northern_ireland_indicators, "data-raw/imd2017_soa01_northern_ireland_indicators.csv")
